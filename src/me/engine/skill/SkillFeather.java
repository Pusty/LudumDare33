...
public class SkillFeather extends Skill {
	public SkillFeather(){
		super();
	}
	...
	public void tick(EntityLiving living, MainClass m) {
		...
		if(living.hasEffect(skillname)==155){
			...
			skillproj[0]=m.getWorld().addEntity(new ProjectileFeather(m,living.getX()+v.x/2f,living.getZ()+v.z/2f,v,this));
			m.getSoundPlayer().playSound("feather", true);
			//Sound here
		}
	}
